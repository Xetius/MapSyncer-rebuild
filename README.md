...
| --- | --- |
| Version | `0.6.0` |
| Release jars | `mapsyncer-rebuild-26.2-0.6.0-client.jar`, `mapsyncer-rebuild-26.2-0.6.0-paper.jar` |
| Minecraft | `26.2` |
...
- Fabric Loader
- Fabric API
- MapSyncer Rebuild (`mapsyncer-rebuild-26.2-0.6.0-client.jar`)

### Server (Paper)

- Paper `26.2` (or a fork such as Purpur)
- The MapSyncer Rebuild plugin (`mapsyncer-rebuild-26.2-0.6.0-paper.jar`)
...
1. Install the server side, either way:
   - Fabric server: put `mapsyncer-rebuild-26.2-0.6.0-client.jar` in `mods/`.
   - Paper server: put `mapsyncer-rebuild-26.2-0.6.0-paper.jar` in `plugins/`.
2. Put `mapsyncer-rebuild-26.2-0.6.0-client.jar` in the client's `mods/` directory. The client is always the Fabric mod.
...
`mod_version` in `gradle.properties` is a plain semantic version, currently `0.6.0`. It is
...
```text
build/libs/mapsyncer-rebuild-26.2-0.6.0-client.jar          # clients, and Fabric servers
build/libs/mapsyncer-rebuild-26.2-0.6.0-client-sources.jar  # sources
paper/build/libs/mapsyncer-rebuild-26.2-0.6.0-paper.jar     # Paper servers
```
...
```text
mapsyncer-rebuild-26.2-0.6.0-client.jar          # clients, and Fabric servers
mapsyncer-rebuild-26.2-0.6.0-paper.jar           # Paper servers
mapsyncer-rebuild-26.2-0.6.0-client-sources.jar  # sources
```
