...
- Fabric Loader
- Fabric API
- `mapsyncer-rebuild-26.2-0.6.0-client.jar`

### Server (Paper)

Put this in the server's `plugins/` directory:

- `mapsyncer-rebuild-26.2-0.6.0-paper.jar`
...
```text
build/libs/mapsyncer-rebuild-26.2-0.6.0-client.jar        # client, and Fabric servers
paper/build/libs/mapsyncer-rebuild-26.2-0.6.0-paper.jar  # Paper plugin
```
...
- the version, e.g. `0.6.0`, as shown in your launcher or by `/plugins`
